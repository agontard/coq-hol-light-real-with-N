...
Axiom thm_ZERO_DEF : 0%N = (mk_num IND_0).
...
Axiom thm_NOT_SUC : forall n : N, ~ ((N.succ n) = (NUMERAL 0%N)).
Axiom thm_num_INDUCTION : forall P : N -> Prop, ((P (NUMERAL 0%N)) /\ (forall n : N, (P n) -> P (N.succ n))) -> forall n : N, P n.
Axiom thm_num_Axiom : forall {A : Type'}, forall e : A, forall f : A -> N -> A, @ex1 (N -> A) (fun fn : N -> A => ((fn (NUMERAL 0%N)) = e) /\ (forall n : N, (fn (N.succ n)) = (f (fn n) n))).
Axiom thm_num_CASES : forall m : N, (m = (NUMERAL 0%N)) \/ (exists n : N, m = (N.succ n)).
Axiom thm_PRE : ((N.pred (NUMERAL 0%N)) = (NUMERAL 0%N)) /\ (forall n : N, (N.pred (N.succ n)) = n).
Axiom thm_ADD : (forall n : N, (N.add (NUMERAL 0%N) n) = n) /\ (forall m : N, forall n : N, (N.add (N.succ m) n) = (N.succ (N.add m n))).
Axiom thm_ADD_0 : forall m : N, (N.add m (NUMERAL 0%N)) = m.
Axiom thm_ADD_SUC : forall m : N, forall n : N, (N.add m (N.succ n)) = (N.succ (N.add m n)).
Axiom thm_ADD_CLAUSES : (forall n : N, (N.add (NUMERAL 0%N) n) = n) /\ ((forall m : N, (N.add m (NUMERAL 0%N)) = m) /\ ((forall m : N, forall n : N, (N.add (N.succ m) n) = (N.succ (N.add m n))) /\ (forall m : N, forall n : N, (N.add m (N.succ n)) = (N.succ (N.add m n))))).
...
Axiom thm_ADD_EQ_0 : forall m : N, forall n : N, ((N.add m n) = (NUMERAL 0%N)) = ((m = (NUMERAL 0%N)) /\ (n = (NUMERAL 0%N))).
...
Axiom thm_EQ_ADD_LCANCEL_0 : forall m : N, forall n : N, ((N.add m n) = m) = (n = (NUMERAL 0%N)).
Axiom thm_EQ_ADD_RCANCEL_0 : forall m : N, forall n : N, ((N.add m n) = n) = (m = (NUMERAL 0%N)).
...
Axiom thm_ONE : (NUMERAL (BIT1 0%N)) = (N.succ (NUMERAL 0%N)).
Axiom thm_TWO : (NUMERAL (BIT0 (BIT1 0%N))) = (N.succ (NUMERAL (BIT1 0%N))).
Axiom thm_ADD1 : forall m : N, (N.succ m) = (N.add m (NUMERAL (BIT1 0%N))).
Axiom thm_MULT : (forall n : N, (N.mul (NUMERAL 0%N) n) = (NUMERAL 0%N)) /\ (forall m : N, forall n : N, (N.mul (N.succ m) n) = (N.add (N.mul m n) n)).
Axiom thm_MULT_0 : forall m : N, (N.mul m (NUMERAL 0%N)) = (NUMERAL 0%N).
Axiom thm_MULT_SUC : forall m : N, forall n : N, (N.mul m (N.succ n)) = (N.add m (N.mul m n)).
Axiom thm_MULT_CLAUSES : (forall n : N, (N.mul (NUMERAL 0%N) n) = (NUMERAL 0%N)) /\ ((forall m : N, (N.mul m (NUMERAL 0%N)) = (NUMERAL 0%N)) /\ ((forall n : N, (N.mul (NUMERAL (BIT1 0%N)) n) = n) /\ ((forall m : N, (N.mul m (NUMERAL (BIT1 0%N))) = m) /\ ((forall m : N, forall n : N, (N.mul (N.succ m) n) = (N.add (N.mul m n) n)) /\ (forall m : N, forall n : N, (N.mul m (N.succ n)) = (N.add m (N.mul m n))))))).
...
Axiom thm_MULT_EQ_0 : forall m : N, forall n : N, ((N.mul m n) = (NUMERAL 0%N)) = ((m = (NUMERAL 0%N)) \/ (n = (NUMERAL 0%N))).
Axiom thm_EQ_MULT_LCANCEL : forall m : N, forall n : N, forall p : N, ((N.mul m n) = (N.mul m p)) = ((m = (NUMERAL 0%N)) \/ (n = p)).
Axiom thm_EQ_MULT_RCANCEL : forall m : N, forall n : N, forall p : N, ((N.mul m p) = (N.mul n p)) = ((m = n) \/ (p = (NUMERAL 0%N))).
Axiom thm_MULT_2 : forall n : N, (N.mul (NUMERAL (BIT0 (BIT1 0%N))) n) = (N.add n n).
Axiom thm_MULT_EQ_1 : forall m : N, forall n : N, ((N.mul m n) = (NUMERAL (BIT1 0%N))) = ((m = (NUMERAL (BIT1 0%N))) /\ (n = (NUMERAL (BIT1 0%N)))).
Axiom thm_EXP : (forall m : N, (N.pow m (NUMERAL 0%N)) = (NUMERAL (BIT1 0%N))) /\ (forall m : N, forall n : N, (N.pow m (N.succ n)) = (N.mul m (N.pow m n))).
Axiom thm_EXP_EQ_0 : forall m : N, forall n : N, ((N.pow m n) = (NUMERAL 0%N)) = ((m = (NUMERAL 0%N)) /\ (~ (n = (NUMERAL 0%N)))).
Axiom thm_EXP_EQ_1 : forall x : N, forall n : N, ((N.pow x n) = (NUMERAL (BIT1 0%N))) = ((x = (NUMERAL (BIT1 0%N))) \/ (n = (NUMERAL 0%N))).
Axiom thm_EXP_ZERO : forall n : N, (N.pow (NUMERAL 0%N) n) = (@COND N (n = (NUMERAL 0%N)) (NUMERAL (BIT1 0%N)) (NUMERAL 0%N)).
Axiom thm_EXP_ADD : forall m : N, forall n : N, forall p : N, (N.pow m (N.add n p)) = (N.mul (N.pow m n) (N.pow m p)).
Axiom thm_EXP_ONE : forall n : N, (N.pow (NUMERAL (BIT1 0%N)) n) = (NUMERAL (BIT1 0%N)).
Axiom thm_EXP_1 : forall n : N, (N.pow n (NUMERAL (BIT1 0%N))) = n.
Axiom thm_EXP_2 : forall n : N, (N.pow n (NUMERAL (BIT0 (BIT1 0%N)))) = (N.mul n n).
...
Axiom thm_LE : (forall m : N, (N.le m (NUMERAL 0%N)) = (m = (NUMERAL 0%N))) /\ (forall m : N, forall n : N, (N.le m (N.succ n)) = ((m = (N.succ n)) \/ (N.le m n))).
Axiom thm_LT : (forall m : N, (N.lt m (NUMERAL 0%N)) = False) /\ (forall m : N, forall n : N, (N.lt m (N.succ n)) = ((m = n) \/ (N.lt m n))).
...
Axiom thm_LE_0 : forall n : N, N.le (NUMERAL 0%N) n.
Axiom thm_LT_0 : forall n : N, N.lt (NUMERAL 0%N) (N.succ n).
...
Axiom thm_LT_NZ : forall n : N, (N.lt (NUMERAL 0%N) n) = (~ (n = (NUMERAL 0%N))).
Axiom thm_LE_1 : (forall n : N, (~ (n = (NUMERAL 0%N))) -> N.lt (NUMERAL 0%N) n) /\ ((forall n : N, (~ (n = (NUMERAL 0%N))) -> N.le (NUMERAL (BIT1 0%N)) n) /\ ((forall n : N, (N.lt (NUMERAL 0%N) n) -> ~ (n = (NUMERAL 0%N))) /\ ((forall n : N, (N.lt (NUMERAL 0%N) n) -> N.le (NUMERAL (BIT1 0%N)) n) /\ ((forall n : N, (N.le (NUMERAL (BIT1 0%N)) n) -> N.lt (NUMERAL 0%N) n) /\ (forall n : N, (N.le (NUMERAL (BIT1 0%N)) n) -> ~ (n = (NUMERAL 0%N))))))).
...
Axiom thm_LT_ADD : forall m : N, forall n : N, (N.lt m (N.add m n)) = (N.lt (NUMERAL 0%N) n).
Axiom thm_LT_ADDR : forall m : N, forall n : N, (N.lt n (N.add m n)) = (N.lt (NUMERAL 0%N) m).
...
Axiom thm_LT_MULT : forall m : N, forall n : N, (N.lt (NUMERAL 0%N) (N.mul m n)) = ((N.lt (NUMERAL 0%N) m) /\ (N.lt (NUMERAL 0%N) n)).
Axiom thm_LE_MULT2 : forall m : N, forall n : N, forall p : N, forall q : N, ((N.le m n) /\ (N.le p q)) -> N.le (N.mul m p) (N.mul n q).
Axiom thm_LT_LMULT : forall m : N, forall n : N, forall p : N, ((~ (m = (NUMERAL 0%N))) /\ (N.lt n p)) -> N.lt (N.mul m n) (N.mul m p).
Axiom thm_LE_MULT_LCANCEL : forall m : N, forall n : N, forall p : N, (N.le (N.mul m n) (N.mul m p)) = ((m = (NUMERAL 0%N)) \/ (N.le n p)).
Axiom thm_LE_MULT_RCANCEL : forall m : N, forall n : N, forall p : N, (N.le (N.mul m p) (N.mul n p)) = ((N.le m n) \/ (p = (NUMERAL 0%N))).
Axiom thm_LT_MULT_LCANCEL : forall m : N, forall n : N, forall p : N, (N.lt (N.mul m n) (N.mul m p)) = ((~ (m = (NUMERAL 0%N))) /\ (N.lt n p)).
Axiom thm_LT_MULT_RCANCEL : forall m : N, forall n : N, forall p : N, (N.lt (N.mul m p) (N.mul n p)) = ((N.lt m n) /\ (~ (p = (NUMERAL 0%N)))).
...
Axiom thm_LT_POW2_REFL : forall n : N, N.lt n (N.pow (NUMERAL (BIT0 (BIT1 0%N))) n).
...
Axiom thm_SUB_REFL : forall n : N, (N.sub n n) = (NUMERAL 0%N).
Axiom thm_ADD_SUB : forall m : N, forall n : N, (N.sub (N.add m n) n) = m.
Axiom thm_ADD_SUB2 : forall m : N, forall n : N, (N.sub (N.add m n) m) = n.
Axiom thm_SUB_EQ_0 : forall m : N, forall n : N, ((N.sub m n) = (NUMERAL 0%N)) = (N.le m n).
Axiom thm_ADD_SUBR2 : forall m : N, forall n : N, (N.sub m (N.add m n)) = (NUMERAL 0%N).
Axiom thm_ADD_SUBR : forall m : N, forall n : N, (N.sub n (N.add m n)) = (NUMERAL 0%N).
...
Axiom thm_EQ_EXP : forall x : N, forall m : N, forall n : N, ((N.pow x m) = (N.pow x n)) = (@COND Prop (x = (NUMERAL 0%N)) ((m = (NUMERAL 0%N)) = (n = (NUMERAL 0%N))) ((x = (NUMERAL (BIT1 0%N))) \/ (m = n))).
Axiom thm_EXP_MONO_LE_IMP : forall x : N, forall y : N, forall n : N, (N.le x y) -> N.le (N.pow x n) (N.pow y n).
Axiom thm_EXP_MONO_LT_IMP : forall x : N, forall y : N, forall n : N, ((N.lt x y) /\ (~ (n = (NUMERAL 0%N)))) -> N.lt (N.pow x n) (N.pow y n).
Axiom thm_EXP_MONO_LE : forall x : N, forall y : N, forall n : N, (N.le (N.pow x n) (N.pow y n)) = ((N.le x y) \/ (n = (NUMERAL 0%N))).
Axiom thm_EXP_MONO_LT : forall x : N, forall y : N, forall n : N, (N.lt (N.pow x n) (N.pow y n)) = ((N.lt x y) /\ (~ (n = (NUMERAL 0%N)))).
Axiom thm_EXP_MONO_EQ : forall x : N, forall y : N, forall n : N, ((N.pow x n) = (N.pow y n)) = ((x = y) \/ (n = (NUMERAL 0%N))).
Axiom thm_DIVMOD_EXIST : forall m : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> exists q : N, exists r : N, (m = (N.add (N.mul q n) r)) /\ (N.lt r n).
Axiom thm_DIVMOD_EXIST_0 : forall m : N, forall n : N, exists q : N, exists r : N, @COND Prop (n = (NUMERAL 0%N)) ((q = (NUMERAL 0%N)) /\ (r = m)) ((m = (N.add (N.mul q n) r)) /\ (N.lt r n)).
Axiom thm_DIVISION : forall m : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (m = (N.add (N.mul (N.div m n) n) (N.modulo m n))) /\ (N.lt (N.modulo m n) n).
Axiom thm_DIV_ZERO : forall n : N, (N.div n (NUMERAL 0%N)) = (NUMERAL 0%N).
Axiom thm_MOD_ZERO : forall n : N, (N.modulo n (NUMERAL 0%N)) = n.
...
Axiom thm_MOD_LT_EQ : forall m : N, forall n : N, (N.lt (N.modulo m n) n) = (~ (n = (NUMERAL 0%N))).
Axiom thm_MOD_LT_EQ_LT : forall m : N, forall n : N, (N.lt (N.modulo m n) n) = (N.lt (NUMERAL 0%N) n).
...
Axiom thm_MOD_0 : forall n : N, (N.modulo (NUMERAL 0%N) n) = (NUMERAL 0%N).
Axiom thm_DIV_0 : forall n : N, (N.div (NUMERAL 0%N) n) = (NUMERAL 0%N).
Axiom thm_MOD_MULT : forall m : N, forall n : N, (N.modulo (N.mul m n) m) = (NUMERAL 0%N).
Axiom thm_DIV_MULT : forall m : N, forall n : N, (~ (m = (NUMERAL 0%N))) -> (N.div (N.mul m n) m) = n.
Axiom thm_MOD_LT : forall m : N, forall n : N, (N.lt m n) -> (N.modulo m n) = m.
Axiom thm_MOD_EQ_SELF : forall m : N, forall n : N, ((N.modulo m n) = m) = ((n = (NUMERAL 0%N)) \/ (N.lt m n)).
Axiom thm_MOD_CASES : forall n : N, forall p : N, (N.lt n (N.mul (NUMERAL (BIT0 (BIT1 0%N))) p)) -> (N.modulo n p) = (@COND N (N.lt n p) n (N.sub n p)).
...
Axiom thm_MOD_LE_TWICE : forall m : N, forall n : N, ((N.lt (NUMERAL 0%N) m) /\ (N.le m n)) -> N.le (N.mul (NUMERAL (BIT0 (BIT1 0%N))) (N.modulo n m)) n.
Axiom thm_MOD_1 : forall n : N, (N.modulo n (NUMERAL (BIT1 0%N))) = (NUMERAL 0%N).
Axiom thm_DIV_1 : forall n : N, (N.div n (NUMERAL (BIT1 0%N))) = n.
Axiom thm_DIV_LT : forall m : N, forall n : N, (N.lt m n) -> (N.div m n) = (NUMERAL 0%N).
...
Axiom thm_LE_RDIV_EQ : forall a : N, forall b : N, forall n : N, (~ (a = (NUMERAL 0%N))) -> (N.le n (N.div b a)) = (N.le (N.mul a n) b).
Axiom thm_RDIV_LT_EQ : forall a : N, forall b : N, forall n : N, (~ (a = (NUMERAL 0%N))) -> (N.lt (N.div b a) n) = (N.lt b (N.mul a n)).
Axiom thm_LE_LDIV_EQ : forall a : N, forall b : N, forall n : N, (~ (a = (NUMERAL 0%N))) -> (N.le (N.div b a) n) = (N.lt b (N.mul a (N.add n (NUMERAL (BIT1 0%N))))).
Axiom thm_LDIV_LT_EQ : forall a : N, forall b : N, forall n : N, (~ (a = (NUMERAL 0%N))) -> (N.lt n (N.div b a)) = (N.le (N.mul a (N.add n (NUMERAL (BIT1 0%N)))) b).
Axiom thm_LE_LDIV : forall a : N, forall b : N, forall n : N, ((~ (a = (NUMERAL 0%N))) /\ (N.le b (N.mul a n))) -> N.le (N.div b a) n.
Axiom thm_DIV_MONO : forall m : N, forall n : N, forall p : N, (N.le m n) -> N.le (N.div m p) (N.div n p).
Axiom thm_DIV_MONO_LT : forall m : N, forall n : N, forall p : N, ((~ (p = (NUMERAL 0%N))) /\ (N.le (N.add m p) n)) -> N.lt (N.div m p) (N.div n p).
Axiom thm_DIV_EQ_0 : forall m : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> ((N.div m n) = (NUMERAL 0%N)) = (N.lt m n).
Axiom thm_MOD_DIV_EQ_0 : forall m : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div (N.modulo m n) n) = (NUMERAL 0%N).
...
Axiom thm_DIV_MULT_ADD : (forall a : N, forall b : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div (N.add (N.mul a n) b) n) = (N.add a (N.div b n))) /\ ((forall a : N, forall b : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div (N.add (N.mul n a) b) n) = (N.add a (N.div b n))) /\ ((forall a : N, forall b : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div (N.add b (N.mul a n)) n) = (N.add (N.div b n) a)) /\ (forall a : N, forall b : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div (N.add b (N.mul n a)) n) = (N.add (N.div b n) a)))).
Axiom thm_MOD_ADD_MOD : forall a : N, forall b : N, forall n : N, (N.modulo (N.add (N.modulo a n) (N.modulo b n)) n) = (N.modulo (N.add a b) n).
Axiom thm_DIV_ADD_MOD : forall a : N, forall b : N, forall n : N, (~ (n = (NUMERAL 0%N))) -> ((N.modulo (N.add a b) n) = (N.add (N.modulo a n) (N.modulo b n))) = ((N.div (N.add a b) n) = (N.add (N.div a n) (N.div b n))).
Axiom thm_MOD_ADD_EQ_EQ : forall n : N, forall x : N, forall y : N, ((N.modulo (N.add x y) n) = (N.add (N.modulo x n) (N.modulo y n))) = ((n = (NUMERAL 0%N)) \/ (N.lt (N.add (N.modulo x n) (N.modulo y n)) n)).
Axiom thm_DIV_ADD_EQ_EQ : forall n : N, forall x : N, forall y : N, ((N.div (N.add x y) n) = (N.add (N.div x n) (N.div y n))) = ((n = (NUMERAL 0%N)) \/ (N.lt (N.add (N.modulo x n) (N.modulo y n)) n)).
...
Axiom thm_DIV_REFL : forall n : N, (~ (n = (NUMERAL 0%N))) -> (N.div n n) = (NUMERAL (BIT1 0%N)).
Axiom thm_MOD_LE : forall m : N, forall n : N, N.le (N.modulo m n) m.
Axiom thm_DIV_MONO2 : forall m : N, forall n : N, forall p : N, ((~ (p = (NUMERAL 0%N))) /\ (N.le p m)) -> N.le (N.div n m) (N.div n p).
Axiom thm_DIV_LE_EXCLUSION : forall a : N, forall b : N, forall c : N, forall d : N, ((~ (b = (NUMERAL 0%N))) /\ (N.lt (N.mul b c) (N.mul (N.add a (NUMERAL (BIT1 0%N))) d))) -> N.le (N.div c d) (N.div a b).
Axiom thm_DIV_EQ_EXCLUSION : forall a : N, forall b : N, forall c : N, forall d : N, ((N.lt (N.mul b c) (N.mul (N.add a (NUMERAL (BIT1 0%N))) d)) /\ (N.lt (N.mul a d) (N.mul (N.add c (NUMERAL (BIT1 0%N))) b))) -> (N.div a b) = (N.div c d).
...
Axiom thm_MOD_EXP : forall m : N, forall n : N, forall p : N, (~ (m = (NUMERAL 0%N))) -> (N.modulo (N.pow m n) (N.pow m p)) = (@COND N ((N.le p n) \/ (m = (NUMERAL (BIT1 0%N)))) (NUMERAL 0%N) (N.pow m n)).
Axiom thm_DIV_EXP : forall m : N, forall n : N, forall p : N, (~ (m = (NUMERAL 0%N))) -> (N.div (N.pow m n) (N.pow m p)) = (@COND N (N.le p n) (N.pow m (N.sub n p)) (@COND N (m = (NUMERAL (BIT1 0%N))) (NUMERAL (BIT1 0%N)) (NUMERAL 0%N))).
Axiom thm_FORALL_LT_MOD_THM : forall P : N -> Prop, forall n : N, (forall a : N, (N.lt a n) -> P a) = ((n = (NUMERAL 0%N)) \/ (forall a : N, P (N.modulo a n))).
Axiom thm_FORALL_MOD_THM : forall P : N -> Prop, forall n : N, (~ (n = (NUMERAL 0%N))) -> (forall a : N, P (N.modulo a n)) = (forall a : N, (N.lt a n) -> P a).
Axiom thm_EXISTS_LT_MOD_THM : forall P : N -> Prop, forall n : N, (exists a : N, (N.lt a n) /\ (P a)) = ((~ (n = (NUMERAL 0%N))) /\ (exists a : N, P (N.modulo a n))).
Axiom thm_EXISTS_MOD_THM : forall P : N -> Prop, forall n : N, (~ (n = (NUMERAL 0%N))) -> (exists a : N, P (N.modulo a n)) = (exists a : N, (N.lt a n) /\ (P a)).
Axiom thm_PRE_ELIM_THM : forall (n : N) (P : N -> Prop), (P (N.pred n)) = (forall m : N, ((n = (N.succ m)) \/ ((m = (NUMERAL 0%N)) /\ (n = (NUMERAL 0%N)))) -> P m).
Axiom thm_SUB_ELIM_THM : forall (a : N) (b : N) (P : N -> Prop), (P (N.sub a b)) = (forall d : N, ((a = (N.add b d)) \/ ((N.lt a b) /\ (d = (NUMERAL 0%N)))) -> P d).
Axiom thm_DIVMOD_ELIM_THM : forall (m : N) (n : N) (P : N -> N -> Prop), (P (N.div m n) (N.modulo m n)) = (forall q : N, forall r : N, (((n = (NUMERAL 0%N)) /\ ((q = (NUMERAL 0%N)) /\ (r = m))) \/ ((m = (N.add (N.mul q n) r)) /\ (N.lt r n))) -> P q r).
...
Axiom thm_ARITH_SUC : (forall n : N, (N.succ (NUMERAL n)) = (NUMERAL (N.succ n))) /\ (((N.succ 0%N) = (BIT1 0%N)) /\ ((forall n : N, (N.succ (BIT0 n)) = (BIT1 n)) /\ (forall n : N, (N.succ (BIT1 n)) = (BIT0 (N.succ n))))).
Axiom thm_ARITH_PRE : (forall n : N, (N.pred (NUMERAL n)) = (NUMERAL (N.pred n))) /\ (((N.pred 0%N) = 0%N) /\ ((forall n : N, (N.pred (BIT0 n)) = (@COND N (n = 0%N) 0%N (BIT1 (N.pred n)))) /\ (forall n : N, (N.pred (BIT1 n)) = (BIT0 n)))).
...
Axiom thm_ARITH_SUB : (forall m : N, forall n : N, (N.sub (NUMERAL m) (NUMERAL n)) = (NUMERAL (N.sub m n))) /\ (((N.sub 0%N 0%N) = 0%N) /\ ((forall n : N, (N.sub 0%N (BIT0 n)) = 0%N) /\ ((forall n : N, (N.sub 0%N (BIT1 n)) = 0%N) /\ ((forall n : N, (N.sub (BIT0 n) 0%N) = (BIT0 n)) /\ ((forall n : N, (N.sub (BIT1 n) 0%N) = (BIT1 n)) /\ ((forall m : N, forall n : N, (N.sub (BIT0 m) (BIT0 n)) = (BIT0 (N.sub m n))) /\ ((forall m : N, forall n : N, (N.sub (BIT0 m) (BIT1 n)) = (N.pred (BIT0 (N.sub m n)))) /\ ((forall m : N, forall n : N, (N.sub (BIT1 m) (BIT0 n)) = (@COND N (N.le n m) (BIT1 (N.sub m n)) 0%N)) /\ (forall m : N, forall n : N, (N.sub (BIT1 m) (BIT1 n)) = (BIT0 (N.sub m n))))))))))).
Axiom thm_EXP_2_NE_0 : forall n : N, ~ ((N.pow (NUMERAL (BIT0 (BIT1 0%N))) n) = (NUMERAL 0%N)).
...
Axiom thm_NUMPAIR : forall x : N, forall y : N, (NUMPAIR x y) = (N.mul (N.pow (NUMERAL (BIT0 (BIT1 0%N))) x) (N.add (N.mul (NUMERAL (BIT0 (BIT1 0%N))) y) (NUMERAL (BIT1 0%N)))).
...
Axiom thm_NUMSUM : forall b : Prop, forall x : N, (NUMSUM b x) = (@COND N b (N.succ (N.mul (NUMERAL (BIT0 (BIT1 0%N))) x)) (N.mul (NUMERAL (BIT0 (BIT1 0%N))) x)).
...
Axiom thm_ZBOT : forall {A : Type'}, (@ZBOT A) = (@INJP A (@INJN A (NUMERAL 0%N)) (@ε (N -> A -> Prop) (fun z : N -> A -> Prop => True))).
...
Axiom thm_FCONS : forall {A : Type'}, (forall a : A, forall f : N -> A, (@FCONS A a f (NUMERAL 0%N)) = a) /\ (forall a : A, forall f : N -> A, forall n : N, (@FCONS A a f (N.succ n)) = (f n)).
Axiom thm_FCONS_UNDO : forall {A : Type'}, forall f : N -> A, f = (@FCONS A (f (NUMERAL 0%N)) (@o N N A f N.succ)).
...
Axiom thm_LENGTH : forall {A : Type'}, ((@LENGTH A (@nil A)) = (NUMERAL 0%N)) /\ (forall h : A, forall t : list A, (@LENGTH A (@cons A h t)) = (N.succ (@LENGTH A t))).
...
Axiom thm_REPLICATE : forall {A : Type'} (n : N) (x : A), ((@REPLICATE A (NUMERAL 0%N) x) = (@nil A)) /\ ((@REPLICATE A (N.succ n) x) = (@cons A x (@REPLICATE A n x))).
...
Axiom thm_EL : forall {A : Type'} (n : N) (l : list A), ((@EL A (NUMERAL 0%N) l) = (@hd A l)) /\ ((@EL A (N.succ n) l) = (@EL A n (@tl A l))).
...
Axiom thm_list_of_seq : forall {A : Type'} (s : N -> A) (n : N), ((@list_of_seq A s (NUMERAL 0%N)) = (@nil A)) /\ ((@list_of_seq A s (N.succ n)) = (@List.app A (@list_of_seq A s n) (@cons A (s n) (@nil A)))).
...
Axiom thm_LENGTH_APPEND : forall {A : Type'}, forall l : list A, forall m : list A, (@LENGTH A (@List.app A l m)) = (N.add (@LENGTH A l) (@LENGTH A m)).
...
Axiom thm_LENGTH_EQ_NIL : forall {A : Type'}, forall l : list A, ((@LENGTH A l) = (NUMERAL 0%N)) = (l = (@nil A)).
...
Axiom thm_MEM_REPLICATE : forall {A : Type'}, forall n : N, forall x : A, forall y : A, (@List.In A x (@REPLICATE A n y)) = ((x = y) /\ (~ (n = (NUMERAL 0%N)))).
...
Axiom thm_LENGTH_TL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@LENGTH A (@tl A l)) = (N.sub (@LENGTH A l) (NUMERAL (BIT1 0%N))).
...
Axiom thm_EL_APPEND : forall {A : Type'}, forall k : N, forall l : list A, forall m : list A, (@EL A k (@List.app A l m)) = (@COND A (N.lt k (@LENGTH A l)) (@EL A k l) (@EL A (N.sub k (@LENGTH A l)) m)).
Axiom thm_EL_TL : forall {A : Type'} (l : list A), forall n : N, (@EL A n (@tl A l)) = (@EL A (N.add n (NUMERAL (BIT1 0%N))) l).
Axiom thm_EL_CONS : forall {A : Type'}, forall n : N, forall h : A, forall t : list A, (@EL A n (@cons A h t)) = (@COND A (n = (NUMERAL 0%N)) h (@EL A (N.sub n (NUMERAL (BIT1 0%N))) t)).
Axiom thm_LAST_EL : forall {A : Type'}, forall l : list A, (~ (l = (@nil A))) -> (@LAST A l) = (@EL A (N.sub (@LENGTH A l) (NUMERAL (BIT1 0%N))) l).
...
Axiom thm_LIST_OF_SEQ_EQ_NIL : forall {A : Type'}, forall s : N -> A, forall n : N, ((@list_of_seq A s n) = (@nil A)) = (n = (NUMERAL 0%N)).
...
Axiom thm_DIST_REFL : forall n : N, (dist (@pair N N n n)) = (NUMERAL 0%N).
Axiom thm_DIST_LZERO : forall n : N, (dist (@pair N N (NUMERAL 0%N) n)) = n.
Axiom thm_DIST_RZERO : forall n : N, (dist (@pair N N n (NUMERAL 0%N))) = n.
...
Axiom thm_DIST_EQ_0 : forall m : N, forall n : N, ((dist (@pair N N m n)) = (NUMERAL 0%N)) = (m = n).
...
Axiom thm_BOUNDS_LINEAR_0 : forall A : N, forall B : N, (forall n : N, N.le (N.mul A n) B) = (A = (NUMERAL 0%N)).
...
Axiom thm_BOUNDS_NOTZERO : forall P : N -> N -> N, forall A : N, forall B : N, (((P (NUMERAL 0%N) (NUMERAL 0%N)) = (NUMERAL 0%N)) /\ (forall m : N, forall n : N, N.le (P m n) (N.add (N.mul A (N.add m n)) B))) -> exists B' : N, forall m : N, forall n : N, N.le (P m n) (N.mul B' (N.add m n)).
...
Axiom thm_is_nadd_0 : is_nadd (fun n : N => NUMERAL 0%N).
...
Axiom thm_NADD_LE_TOTAL_LEMMA : forall x : nadd, forall y : nadd, (~ (nadd_le x y)) -> forall B : N, exists n : N, (~ (n = (NUMERAL 0%N))) /\ (N.lt (N.add (dest_nadd y n) B) (dest_nadd x n)).
...
Axiom thm_NADD_ADD_LID : forall x : nadd, nadd_eq (nadd_add (nadd_of_num (NUMERAL 0%N)) x) x.
...
Axiom thm_NADD_MUL_LID : forall x : nadd, nadd_eq (nadd_mul (nadd_of_num (NUMERAL (BIT1 0%N))) x) x.
...
Axiom thm_NADD_LE_0 : forall x : nadd, nadd_le (nadd_of_num (NUMERAL 0%N)) x.
...
Axiom thm_NADD_ARCH_MULT : forall x : nadd, forall k : N, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists N' : N, nadd_le (nadd_of_num k) (nadd_mul (nadd_of_num N') x).
Axiom thm_NADD_ARCH_ZERO : forall x : nadd, forall k : nadd, (forall n : N, nadd_le (nadd_mul (nadd_of_num n) x) k) -> nadd_eq x (nadd_of_num (NUMERAL 0%N)).
...
Axiom thm_NADD_NONZERO : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists N' : N, forall n : N, (N.le N' n) -> ~ ((dest_nadd x n) = (NUMERAL 0%N)).
Axiom thm_NADD_LBOUND : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists A : N, exists N' : N, forall n : N, (N.le N' n) -> N.le n (N.mul A (dest_nadd x n)).
Axiom thm_nadd_rinv : forall x : nadd, (nadd_rinv x) = (fun n : N => N.div (N.mul n n) (dest_nadd x n)).
Axiom thm_NADD_MUL_LINV_LEMMA0 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists A : N, exists B : N, forall n : N, N.le (nadd_rinv x n) (N.add (N.mul A n) B).
Axiom thm_NADD_MUL_LINV_LEMMA1 : forall x : nadd, forall n : N, (~ ((dest_nadd x n) = (NUMERAL 0%N))) -> N.le (dist (@pair N N (N.mul (dest_nadd x n) (nadd_rinv x n)) (N.mul n n))) (dest_nadd x n).
Axiom thm_NADD_MUL_LINV_LEMMA2 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists N' : N, forall n : N, (N.le N' n) -> N.le (dist (@pair N N (N.mul (dest_nadd x n) (nadd_rinv x n)) (N.mul n n))) (dest_nadd x n).
Axiom thm_NADD_MUL_LINV_LEMMA3 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists N' : N, forall m : N, forall n : N, (N.le N' n) -> N.le (dist (@pair N N (N.mul m (N.mul (dest_nadd x m) (N.mul (dest_nadd x n) (nadd_rinv x n)))) (N.mul m (N.mul (dest_nadd x m) (N.mul n n))))) (N.mul m (N.mul (dest_nadd x m) (dest_nadd x n))).
Axiom thm_NADD_MUL_LINV_LEMMA4 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists N' : N, forall m : N, forall n : N, ((N.le N' m) /\ (N.le N' n)) -> N.le (N.mul (N.mul (dest_nadd x m) (dest_nadd x n)) (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m))))) (N.add (N.mul (N.mul m n) (dist (@pair N N (N.mul m (dest_nadd x n)) (N.mul n (dest_nadd x m))))) (N.mul (N.mul (dest_nadd x m) (dest_nadd x n)) (N.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA5 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists B : N, exists N' : N, forall m : N, forall n : N, ((N.le N' m) /\ (N.le N' n)) -> N.le (N.mul (N.mul (dest_nadd x m) (dest_nadd x n)) (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m))))) (N.mul B (N.mul (N.mul m n) (N.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA6 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists B : N, exists N' : N, forall m : N, forall n : N, ((N.le N' m) /\ (N.le N' n)) -> N.le (N.mul (N.mul m n) (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m))))) (N.mul B (N.mul (N.mul m n) (N.add m n))).
Axiom thm_NADD_MUL_LINV_LEMMA7 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists B : N, exists N' : N, forall m : N, forall n : N, ((N.le N' m) /\ (N.le N' n)) -> N.le (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m)))) (N.mul B (N.add m n)).
Axiom thm_NADD_MUL_LINV_LEMMA7a : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> forall N' : N, exists A : N, exists B : N, forall m : N, forall n : N, (N.le m N') -> N.le (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m)))) (N.add (N.mul A n) B).
Axiom thm_NADD_MUL_LINV_LEMMA8 : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> exists B : N, forall m : N, forall n : N, N.le (dist (@pair N N (N.mul m (nadd_rinv x n)) (N.mul n (nadd_rinv x m)))) (N.mul B (N.add m n)).
Axiom thm_nadd_inv : forall x : nadd, (nadd_inv x) = (@COND nadd (nadd_eq x (nadd_of_num (NUMERAL 0%N))) (nadd_of_num (NUMERAL 0%N)) (mk_nadd (nadd_rinv x))).
Axiom thm_NADD_INV : forall x : nadd, (dest_nadd (nadd_inv x)) = (@COND (N -> N) (nadd_eq x (nadd_of_num (NUMERAL 0%N))) (fun n : N => NUMERAL 0%N) (nadd_rinv x)).
Axiom thm_NADD_MUL_LINV : forall x : nadd, (~ (nadd_eq x (nadd_of_num (NUMERAL 0%N)))) -> nadd_eq (nadd_mul (nadd_inv x) x) (nadd_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_NADD_INV_0 : nadd_eq (nadd_inv (nadd_of_num (NUMERAL 0%N))) (nadd_of_num (NUMERAL 0%N)).
...
Axiom thm_HREAL_ADD_LID : forall x : hreal, (hreal_add (hreal_of_num (NUMERAL 0%N)) x) = x.
...
Axiom thm_HREAL_MUL_LID : forall x : hreal, (hreal_mul (hreal_of_num (NUMERAL (BIT1 0%N))) x) = x.
...
Axiom thm_HREAL_MUL_LINV : forall x : hreal, (~ (x = (hreal_of_num (NUMERAL 0%N)))) -> (hreal_mul (hreal_inv x) x) = (hreal_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_HREAL_INV_0 : (hreal_inv (hreal_of_num (NUMERAL 0%N))) = (hreal_of_num (NUMERAL 0%N)).
...
Axiom thm_HREAL_ADD_RID : forall n : hreal, (hreal_add n (hreal_of_num (NUMERAL 0%N))) = n.
...
Axiom thm_HREAL_MUL_LZERO : forall m : hreal, (hreal_mul (hreal_of_num (NUMERAL 0%N)) m) = (hreal_of_num (NUMERAL 0%N)).
Axiom thm_HREAL_MUL_RZERO : forall m : hreal, (hreal_mul m (hreal_of_num (NUMERAL 0%N))) = (hreal_of_num (NUMERAL 0%N)).
...
Axiom thm_treal_of_num : forall n : N, (treal_of_num n) = (@pair hreal hreal (hreal_of_num n) (hreal_of_num (NUMERAL 0%N))).
...
Axiom thm_TREAL_ADD_LID : forall x : prod hreal hreal, treal_eq (treal_add (treal_of_num (NUMERAL 0%N)) x) x.
Axiom thm_TREAL_ADD_LINV : forall x : prod hreal hreal, treal_eq (treal_add (treal_neg x) x) (treal_of_num (NUMERAL 0%N)).
...
Axiom thm_TREAL_MUL_LID : forall x : prod hreal hreal, treal_eq (treal_mul (treal_of_num (NUMERAL (BIT1 0%N))) x) x.
...
Axiom thm_TREAL_LE_MUL : forall x : prod hreal hreal, forall y : prod hreal hreal, ((treal_le (treal_of_num (NUMERAL 0%N)) x) /\ (treal_le (treal_of_num (NUMERAL 0%N)) y)) -> treal_le (treal_of_num (NUMERAL 0%N)) (treal_mul x y).
Axiom thm_TREAL_INV_0 : treal_eq (treal_inv (treal_of_num (NUMERAL 0%N))) (treal_of_num (NUMERAL 0%N)).
Axiom thm_TREAL_MUL_LINV : forall x : prod hreal hreal, (~ (treal_eq x (treal_of_num (NUMERAL 0%N)))) -> treal_eq (treal_mul (treal_inv x) x) (treal_of_num (NUMERAL (BIT1 0%N))).
...
Axiom thm_REAL_ADD_LID : forall x : real, (real_add (real_of_num (NUMERAL 0%N)) x) = x.
Axiom thm_REAL_ADD_LINV : forall x : real, (real_add (real_neg x) x) = (real_of_num (NUMERAL 0%N)).
...
Axiom thm_REAL_MUL_LID : forall x : real, (real_mul (real_of_num (NUMERAL (BIT1 0%N))) x) = x.
...
Axiom thm_REAL_LE_MUL : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_of_num (NUMERAL 0%N)) y)) -> real_le (real_of_num (NUMERAL 0%N)) (real_mul x y).
Axiom thm_REAL_INV_0 : (real_inv (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
Axiom thm_REAL_MUL_LINV : forall x : real, (~ (x = (real_of_num (NUMERAL 0%N)))) -> (real_mul (real_inv x) x) = (real_of_num (NUMERAL (BIT1 0%N))).
...
Axiom thm_real_abs : forall x : real, (real_abs x) = (@COND real (real_le (real_of_num (NUMERAL 0%N)) x) x (real_neg x)).
Axiom thm_real_pow : forall (x : real), ((real_pow x (NUMERAL 0%N)) = (real_of_num (NUMERAL (BIT1 0%N)))) /\ (forall n : N, (real_pow x (N.succ n)) = (real_mul x (real_pow x n))).
...
Axiom thm_REAL_HREAL_LEMMA1 : exists r : hreal -> real, (forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) = (exists y : hreal, x = (r y))) /\ (forall y : hreal, forall z : hreal, (hreal_le y z) = (real_le (r y) (r z))).
Axiom thm_REAL_HREAL_LEMMA2 : exists h : real -> hreal, exists r : hreal -> real, (forall x : hreal, (h (r x)) = x) /\ ((forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> (r (h x)) = x) /\ ((forall x : hreal, real_le (real_of_num (NUMERAL 0%N)) (r x)) /\ (forall x : hreal, forall y : hreal, (hreal_le x y) = (real_le (r x) (r y))))).
Axiom thm_REAL_COMPLETE_SOMEPOS : forall P : real -> Prop, ((exists x : real, (P x) /\ (real_le (real_of_num (NUMERAL 0%N)) x)) /\ (exists M : real, forall x : real, (P x) -> real_le x M)) -> exists M : real, (forall x : real, (P x) -> real_le x M) /\ (forall M' : real, (forall x : real, (P x) -> real_le x M') -> real_le M M').
...
Axiom thm_REAL_ADD_RINV : forall x : real, (real_add x (real_neg x)) = (real_of_num (NUMERAL 0%N)).
...
Axiom thm_REAL_MUL_RZERO : forall x : real, (real_mul x (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
Axiom thm_REAL_MUL_LZERO : forall x : real, (real_mul (real_of_num (NUMERAL 0%N)) x) = (real_of_num (NUMERAL 0%N)).
...
Axiom thm_REAL_ADD_RID : forall x : real, (real_add x (real_of_num (NUMERAL 0%N))) = x.
Axiom thm_REAL_NEG_0 : (real_neg (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
Axiom thm_REAL_LE_LNEG : forall x : real, forall y : real, (real_le (real_neg x) y) = (real_le (real_of_num (NUMERAL 0%N)) (real_add x y)).
...
Axiom thm_REAL_LE_ADD : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_of_num (NUMERAL 0%N)) y)) -> real_le (real_of_num (NUMERAL 0%N)) (real_add x y).
Axiom thm_REAL_LTE_ANTISYM : forall x : real, forall y : real, ~ ((real_lt x y) /\ (real_le y x)).
Axiom thm_REAL_SUB_LE : forall x : real, forall y : real, (real_le (real_of_num (NUMERAL 0%N)) (real_sub x y)) = (real_le y x).
...
Axiom thm_REAL_SUB_LT : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_sub x y)) = (real_lt y x).
Axiom thm_REAL_NOT_LT : forall x : real, forall y : real, (~ (real_lt x y)) = (real_le y x).
Axiom thm_REAL_SUB_0 : forall x : real, forall y : real, ((real_sub x y) = (real_of_num (NUMERAL 0%N))) = (x = y).
...
Axiom thm_REAL_LTE_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_of_num (NUMERAL 0%N)) y)) -> real_lt (real_of_num (NUMERAL 0%N)) (real_add x y).
Axiom thm_REAL_LET_ADD : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) -> real_lt (real_of_num (NUMERAL 0%N)) (real_add x y).
Axiom thm_REAL_LT_ADD : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) -> real_lt (real_of_num (NUMERAL 0%N)) (real_add x y).
Axiom thm_REAL_ENTIRE : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL 0%N))) = ((x = (real_of_num (NUMERAL 0%N))) \/ (y = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_LE_NEGTOTAL : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) \/ (real_le (real_of_num (NUMERAL 0%N)) (real_neg x)).
Axiom thm_REAL_LE_SQUARE : forall x : real, real_le (real_of_num (NUMERAL 0%N)) (real_mul x x).
Axiom thm_REAL_MUL_RID : forall x : real, (real_mul x (real_of_num (NUMERAL (BIT1 0%N)))) = x.
Axiom thm_REAL_POW_2 : forall x : real, (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))) = (real_mul x x).
Axiom thm_REAL_POLY_CLAUSES : (forall x : real, forall y : real, forall z : real, (real_add x (real_add y z)) = (real_add (real_add x y) z)) /\ ((forall x : real, forall y : real, (real_add x y) = (real_add y x)) /\ ((forall x : real, (real_add (real_of_num (NUMERAL 0%N)) x) = x) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_mul y z)) = (real_mul (real_mul x y) z)) /\ ((forall x : real, forall y : real, (real_mul x y) = (real_mul y x)) /\ ((forall x : real, (real_mul (real_of_num (NUMERAL (BIT1 0%N))) x) = x) /\ ((forall x : real, (real_mul (real_of_num (NUMERAL 0%N)) x) = (real_of_num (NUMERAL 0%N))) /\ ((forall x : real, forall y : real, forall z : real, (real_mul x (real_add y z)) = (real_add (real_mul x y) (real_mul x z))) /\ ((forall x : real, (real_pow x (NUMERAL 0%N)) = (real_of_num (NUMERAL (BIT1 0%N)))) /\ (forall x : real, forall n : N, (real_pow x (N.succ n)) = (real_mul x (real_pow x n))))))))))).
Axiom thm_REAL_POLY_NEG_CLAUSES : (forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num (NUMERAL (BIT1 0%N)))) x)) /\ (forall x : real, forall y : real, (real_sub x y) = (real_add x (real_mul (real_neg (real_of_num (NUMERAL (BIT1 0%N)))) y))).
Axiom thm_REAL_POS : forall n : N, real_le (real_of_num (NUMERAL 0%N)) (real_of_num n).
Axiom thm_REAL_LT_NZ : forall n : N, (~ ((real_of_num n) = (real_of_num (NUMERAL 0%N)))) = (real_lt (real_of_num (NUMERAL 0%N)) (real_of_num n)).
Axiom thm_REAL_POS_LT : forall n : N, real_lt (real_of_num (NUMERAL 0%N)) (real_of_num (N.succ n)).
...
Axiom thm_REAL_OF_NUM_SUC : forall n : N, (real_add (real_of_num n) (real_of_num (NUMERAL (BIT1 0%N)))) = (real_of_num (N.succ n)).
...
Axiom thm_REAL_LT_MUL : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) -> real_lt (real_of_num (NUMERAL 0%N)) (real_mul x y).
Axiom thm_REAL_EQ_ADD_LCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = x) = (y = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_EQ_ADD_RCANCEL_0 : forall x : real, forall y : real, ((real_add x y) = y) = (x = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_LNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (NUMERAL 0%N))) = (x = (real_neg y)).
Axiom thm_REAL_RNEG_UNIQ : forall x : real, forall y : real, ((real_add x y) = (real_of_num (NUMERAL 0%N))) = (y = (real_neg x)).
...
Axiom thm_REAL_NEG_LT0 : forall x : real, (real_lt (real_neg x) (real_of_num (NUMERAL 0%N))) = (real_lt (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_NEG_GT0 : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_neg x)) = (real_lt x (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_NEG_LE0 : forall x : real, (real_le (real_neg x) (real_of_num (NUMERAL 0%N))) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_NEG_GE0 : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) (real_neg x)) = (real_le x (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_LT_TOTAL : forall x : real, forall y : real, (x = y) \/ ((real_lt x y) \/ (real_lt y x)).
Axiom thm_REAL_LT_NEGTOTAL : forall x : real, (x = (real_of_num (NUMERAL 0%N))) \/ ((real_lt (real_of_num (NUMERAL 0%N)) x) \/ (real_lt (real_of_num (NUMERAL 0%N)) (real_neg x))).
Axiom thm_REAL_LE_01 : real_le (real_of_num (NUMERAL 0%N)) (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_LT_01 : real_lt (real_of_num (NUMERAL 0%N)) (real_of_num (NUMERAL (BIT1 0%N))).
...
Axiom thm_REAL_LT_LNEG : forall x : real, forall y : real, (real_lt (real_neg x) y) = (real_lt (real_of_num (NUMERAL 0%N)) (real_add x y)).
Axiom thm_REAL_LT_RNEG : forall x : real, forall y : real, (real_lt x (real_neg y)) = (real_lt (real_add x y) (real_of_num (NUMERAL 0%N))).
...
Axiom thm_REAL_LT_ADD1 : forall x : real, forall y : real, (real_le x y) -> real_lt x (real_add y (real_of_num (NUMERAL (BIT1 0%N)))).
...
Axiom thm_REAL_SUB_REFL : forall x : real, (real_sub x x) = (real_of_num (NUMERAL 0%N)).
Axiom thm_REAL_LE_DOUBLE : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) (real_add x x)) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_LE_NEGL : forall x : real, (real_le (real_neg x) x) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_LE_NEGR : forall x : real, (real_le x (real_neg x)) = (real_le x (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_NEG_EQ_0 : forall x : real, ((real_neg x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N))).
...
Axiom thm_REAL_NEG_MINUS1 : forall x : real, (real_neg x) = (real_mul (real_neg (real_of_num (NUMERAL (BIT1 0%N)))) x).
Axiom thm_REAL_LT_IMP_NE : forall x : real, forall y : real, (real_lt x y) -> ~ (x = y).
Axiom thm_REAL_LE_ADDR : forall x : real, forall y : real, (real_le x (real_add x y)) = (real_le (real_of_num (NUMERAL 0%N)) y).
Axiom thm_REAL_LE_ADDL : forall x : real, forall y : real, (real_le y (real_add x y)) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_LT_ADDR : forall x : real, forall y : real, (real_lt x (real_add x y)) = (real_lt (real_of_num (NUMERAL 0%N)) y).
Axiom thm_REAL_LT_ADDL : forall x : real, forall y : real, (real_lt y (real_add x y)) = (real_lt (real_of_num (NUMERAL 0%N)) x).
...
Axiom thm_REAL_SUB_LZERO : forall x : real, (real_sub (real_of_num (NUMERAL 0%N)) x) = (real_neg x).
Axiom thm_REAL_SUB_RZERO : forall x : real, (real_sub x (real_of_num (NUMERAL 0%N))) = x.
...
Axiom thm_REAL_LT_IMP_NZ : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> ~ (x = (real_of_num (NUMERAL 0%N))).
...
Axiom thm_REAL_ABS_ZERO : forall x : real, ((real_abs x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_ABS_0 : (real_abs (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
Axiom thm_REAL_ABS_1 : (real_abs (real_of_num (NUMERAL (BIT1 0%N)))) = (real_of_num (NUMERAL (BIT1 0%N))).
...
Axiom thm_REAL_ABS_POS : forall x : real, real_le (real_of_num (NUMERAL 0%N)) (real_abs x).
Axiom thm_REAL_ABS_SUB : forall x : real, forall y : real, (real_abs (real_sub x y)) = (real_abs (real_sub y x)).
Axiom thm_REAL_ABS_NZ : forall x : real, (~ (x = (real_of_num (NUMERAL 0%N)))) = (real_lt (real_of_num (NUMERAL 0%N)) (real_abs x)).
...
Axiom thm_REAL_ABS_REFL : forall x : real, ((real_abs x) = x) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_ABS_BETWEEN : forall x : real, forall y : real, forall d : real, ((real_lt (real_of_num (NUMERAL 0%N)) d) /\ ((real_lt (real_sub x d) y) /\ (real_lt y (real_add x d)))) = (real_lt (real_abs (real_sub y x)) d).
...
Axiom thm_REAL_ABS_STILLNZ : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_abs y)) -> ~ (x = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_ABS_CASES : forall x : real, (x = (real_of_num (NUMERAL 0%N))) \/ (real_lt (real_of_num (NUMERAL 0%N)) (real_abs x)).
...
Axiom thm_REAL_ABS_SIGN : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) y) -> real_lt (real_of_num (NUMERAL 0%N)) x.
Axiom thm_REAL_ABS_SIGN2 : forall x : real, forall y : real, (real_lt (real_abs (real_sub x y)) (real_neg y)) -> real_lt x (real_of_num (NUMERAL 0%N)).
...
Axiom thm_REAL_ABS_BETWEEN2 : forall x0 : real, forall x : real, forall y0 : real, forall y : real, ((real_lt x0 y0) /\ ((real_lt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) (real_abs (real_sub x x0))) (real_sub y0 x0)) /\ (real_lt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) (real_abs (real_sub y y0))) (real_sub y0 x0)))) -> real_lt x y.
...
Axiom thm_REAL_POW_LE : forall x : real, forall n : N, (real_le (real_of_num (NUMERAL 0%N)) x) -> real_le (real_of_num (NUMERAL 0%N)) (real_pow x n).
Axiom thm_REAL_POW_LT : forall x : real, forall n : N, (real_lt (real_of_num (NUMERAL 0%N)) x) -> real_lt (real_of_num (NUMERAL 0%N)) (real_pow x n).
Axiom thm_REAL_ABS_POW : forall x : real, forall n : N, (real_abs (real_pow x n)) = (real_pow (real_abs x) n).
Axiom thm_REAL_LE_LMUL : forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le y z)) -> real_le (real_mul x y) (real_mul x z).
Axiom thm_REAL_LE_RMUL : forall x : real, forall y : real, forall z : real, ((real_le x y) /\ (real_le (real_of_num (NUMERAL 0%N)) z)) -> real_le (real_mul x z) (real_mul y z).
Axiom thm_REAL_LT_LMUL : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt y z)) -> real_lt (real_mul x y) (real_mul x z).
Axiom thm_REAL_LT_RMUL : forall x : real, forall y : real, forall z : real, ((real_lt x y) /\ (real_lt (real_of_num (NUMERAL 0%N)) z)) -> real_lt (real_mul x z) (real_mul y z).
Axiom thm_REAL_EQ_MUL_LCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x y) = (real_mul x z)) = ((x = (real_of_num (NUMERAL 0%N))) \/ (y = z)).
Axiom thm_REAL_EQ_MUL_RCANCEL : forall x : real, forall y : real, forall z : real, ((real_mul x z) = (real_mul y z)) = ((x = y) \/ (z = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_MUL_LINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL (BIT1 0%N)))) -> (real_inv y) = x.
Axiom thm_REAL_MUL_RINV_UNIQ : forall x : real, forall y : real, ((real_mul x y) = (real_of_num (NUMERAL (BIT1 0%N)))) -> (real_inv x) = y.
...
Axiom thm_REAL_INV_EQ_0 : forall x : real, ((real_inv x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_LT_INV : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> real_lt (real_of_num (NUMERAL 0%N)) (real_inv x).
Axiom thm_REAL_LT_INV_EQ : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_inv x)) = (real_lt (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_INV_NEG : forall x : real, (real_inv (real_neg x)) = (real_neg (real_inv x)).
Axiom thm_REAL_LE_INV_EQ : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) (real_inv x)) = (real_le (real_of_num (NUMERAL 0%N)) x).
Axiom thm_REAL_LE_INV : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> real_le (real_of_num (NUMERAL 0%N)) (real_inv x).
Axiom thm_REAL_MUL_RINV : forall x : real, (~ (x = (real_of_num (NUMERAL 0%N)))) -> (real_mul x (real_inv x)) = (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_INV_1 : (real_inv (real_of_num (NUMERAL (BIT1 0%N)))) = (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_INV_EQ_1 : forall x : real, ((real_inv x) = (real_of_num (NUMERAL (BIT1 0%N)))) = (x = (real_of_num (NUMERAL (BIT1 0%N)))).
Axiom thm_REAL_DIV_1 : forall x : real, (real_div x (real_of_num (NUMERAL (BIT1 0%N)))) = x.
Axiom thm_REAL_DIV_REFL : forall x : real, (~ (x = (real_of_num (NUMERAL 0%N)))) -> (real_div x x) = (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_DIV_RMUL : forall x : real, forall y : real, (~ (y = (real_of_num (NUMERAL 0%N)))) -> (real_mul (real_div x y) y) = x.
Axiom thm_REAL_DIV_LMUL : forall x : real, forall y : real, (~ (y = (real_of_num (NUMERAL 0%N)))) -> (real_mul y (real_div x y)) = x.
Axiom thm_REAL_DIV_EQ_1 : forall x : real, forall y : real, ((real_div x y) = (real_of_num (NUMERAL (BIT1 0%N)))) = ((x = y) /\ ((~ (x = (real_of_num (NUMERAL 0%N)))) /\ (~ (y = (real_of_num (NUMERAL 0%N)))))).
...
Axiom thm_REAL_DIV_EQ_0 : forall x : real, forall y : real, ((real_div x y) = (real_of_num (NUMERAL 0%N))) = ((x = (real_of_num (NUMERAL 0%N))) \/ (y = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_POW_ADD : forall x : real, forall m : N, forall n : N, (real_pow x (N.add m n)) = (real_mul (real_pow x m) (real_pow x n)).
Axiom thm_REAL_POW_NZ : forall x : real, forall n : N, (~ (x = (real_of_num (NUMERAL 0%N)))) -> ~ ((real_pow x n) = (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_POW_SUB : forall x : real, forall m : N, forall n : N, ((~ (x = (real_of_num (NUMERAL 0%N)))) /\ (N.le m n)) -> (real_pow x (N.sub n m)) = (real_div (real_pow x n) (real_pow x m)).
Axiom thm_REAL_LT_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_mul x y) (real_mul x z))) -> real_lt y z.
Axiom thm_REAL_LT_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL 0%N)) z) /\ (real_lt (real_mul x z) (real_mul y z))) -> real_lt x y.
Axiom thm_REAL_LE_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_mul x y) (real_mul x z))) -> real_le y z.
Axiom thm_REAL_LE_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((real_lt (real_of_num (NUMERAL 0%N)) z) /\ (real_le (real_mul x z) (real_mul y z))) -> real_le x y.
Axiom thm_REAL_LE_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_le (real_mul x z) (real_mul y z)) = (real_le x y).
Axiom thm_REAL_LE_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_le (real_mul z x) (real_mul z y)) = (real_le x y).
Axiom thm_REAL_LT_RMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_lt (real_mul x z) (real_mul y z)) = (real_lt x y).
Axiom thm_REAL_LT_LMUL_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_lt (real_mul z x) (real_mul z y)) = (real_lt x y).
Axiom thm_REAL_LE_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> (real_le (real_of_num (NUMERAL 0%N)) (real_mul x y)) = (real_le (real_of_num (NUMERAL 0%N)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) y) -> (real_le (real_of_num (NUMERAL 0%N)) (real_mul x y)) = (real_le (real_of_num (NUMERAL 0%N)) x)).
Axiom thm_REAL_LT_MUL_EQ : (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> (real_lt (real_of_num (NUMERAL 0%N)) (real_mul x y)) = (real_lt (real_of_num (NUMERAL 0%N)) y)) /\ (forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) y) -> (real_lt (real_of_num (NUMERAL 0%N)) (real_mul x y)) = (real_lt (real_of_num (NUMERAL 0%N)) x)).
Axiom thm_REAL_MUL_POS_LT : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_mul x y)) = (((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) \/ ((real_lt x (real_of_num (NUMERAL 0%N))) /\ (real_lt y (real_of_num (NUMERAL 0%N))))).
Axiom thm_REAL_MUL_POS_LE : forall x : real, forall y : real, (real_le (real_of_num (NUMERAL 0%N)) (real_mul x y)) = ((x = (real_of_num (NUMERAL 0%N))) \/ ((y = (real_of_num (NUMERAL 0%N))) \/ (((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) \/ ((real_lt x (real_of_num (NUMERAL 0%N))) /\ (real_lt y (real_of_num (NUMERAL 0%N))))))).
Axiom thm_REAL_LE_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_le x (real_div y z)) = (real_le (real_mul x z) y).
Axiom thm_REAL_LE_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_le (real_div x z) y) = (real_le x (real_mul y z)).
Axiom thm_REAL_LT_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_lt x (real_div y z)) = (real_lt (real_mul x z) y).
Axiom thm_REAL_LT_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_lt (real_div x z) y) = (real_lt x (real_mul y z)).
Axiom thm_REAL_EQ_RDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (x = (real_div y z)) = ((real_mul x z) = y).
Axiom thm_REAL_EQ_LDIV_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> ((real_div x z) = y) = (x = (real_mul y z)).
Axiom thm_REAL_LT_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_lt (real_div x z) (real_div y z)) = (real_lt x y).
Axiom thm_REAL_LE_DIV2_EQ : forall x : real, forall y : real, forall z : real, (real_lt (real_of_num (NUMERAL 0%N)) z) -> (real_le (real_div x z) (real_div y z)) = (real_le x y).
Axiom thm_REAL_MUL_2 : forall x : real, (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) x) = (real_add x x).
Axiom thm_REAL_POW_EQ_0 : forall x : real, forall n : N, ((real_pow x n) = (real_of_num (NUMERAL 0%N))) = ((x = (real_of_num (NUMERAL 0%N))) /\ (~ (n = (NUMERAL 0%N)))).
Axiom thm_REAL_LE_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL 0%N)) w) /\ ((real_le w x) /\ ((real_le (real_of_num (NUMERAL 0%N)) y) /\ (real_le y z)))) -> real_le (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_MUL2 : forall w : real, forall x : real, forall y : real, forall z : real, ((real_le (real_of_num (NUMERAL 0%N)) w) /\ ((real_lt w x) /\ ((real_le (real_of_num (NUMERAL 0%N)) y) /\ (real_lt y z)))) -> real_lt (real_mul w y) (real_mul x z).
Axiom thm_REAL_LT_SQUARE : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_mul x x)) = (~ (x = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_POW_1 : forall x : real, (real_pow x (NUMERAL (BIT1 0%N))) = x.
Axiom thm_REAL_POW_ONE : forall n : N, (real_pow (real_of_num (NUMERAL (BIT1 0%N))) n) = (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_LT_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt x y)) -> real_lt (real_inv y) (real_inv x).
Axiom thm_REAL_LE_INV2 : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_le x y)) -> real_le (real_inv y) (real_inv x).
Axiom thm_REAL_LT_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) y) /\ (real_lt (real_inv y) x)) -> real_lt (real_inv x) y.
Axiom thm_REAL_LT_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt x (real_inv y))) -> real_lt y (real_inv x).
Axiom thm_REAL_LE_LINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) y) /\ (real_le (real_inv y) x)) -> real_le (real_inv x) y.
Axiom thm_REAL_LE_RINV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_le x (real_inv y))) -> real_le y (real_inv x).
Axiom thm_REAL_INV_LE_1 : forall x : real, (real_le (real_of_num (NUMERAL (BIT1 0%N))) x) -> real_le (real_inv x) (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_INV_1_LE : forall x : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_le x (real_of_num (NUMERAL (BIT1 0%N))))) -> real_le (real_of_num (NUMERAL (BIT1 0%N))) (real_inv x).
Axiom thm_REAL_INV_LT_1 : forall x : real, (real_lt (real_of_num (NUMERAL (BIT1 0%N))) x) -> real_lt (real_inv x) (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_INV_1_LT : forall x : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt x (real_of_num (NUMERAL (BIT1 0%N))))) -> real_lt (real_of_num (NUMERAL (BIT1 0%N))) (real_inv x).
Axiom thm_REAL_SUB_INV : forall x : real, forall y : real, ((~ (x = (real_of_num (NUMERAL 0%N)))) /\ (~ (y = (real_of_num (NUMERAL 0%N))))) -> (real_sub (real_inv x) (real_inv y)) = (real_div (real_sub y x) (real_mul x y)).
Axiom thm_REAL_DOWN : forall d : real, (real_lt (real_of_num (NUMERAL 0%N)) d) -> exists e : real, (real_lt (real_of_num (NUMERAL 0%N)) e) /\ (real_lt e d).
Axiom thm_REAL_DOWN2 : forall d1 : real, forall d2 : real, ((real_lt (real_of_num (NUMERAL 0%N)) d1) /\ (real_lt (real_of_num (NUMERAL 0%N)) d2)) -> exists e : real, (real_lt (real_of_num (NUMERAL 0%N)) e) /\ ((real_lt e d1) /\ (real_lt e d2)).
Axiom thm_REAL_POW_LE2 : forall n : N, forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le x y)) -> real_le (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LE_1 : forall n : N, forall x : real, (real_le (real_of_num (NUMERAL (BIT1 0%N))) x) -> real_le (real_of_num (NUMERAL (BIT1 0%N))) (real_pow x n).
Axiom thm_REAL_POW_1_LE : forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le x (real_of_num (NUMERAL (BIT1 0%N))))) -> real_le (real_pow x n) (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_POW_MONO : forall m : N, forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL (BIT1 0%N))) x) /\ (N.le m n)) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LT2 : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL 0%N))) /\ ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_lt x y))) -> real_lt (real_pow x n) (real_pow y n).
Axiom thm_REAL_POW_LT_1 : forall n : N, forall x : real, ((~ (n = (NUMERAL 0%N))) /\ (real_lt (real_of_num (NUMERAL (BIT1 0%N))) x)) -> real_lt (real_of_num (NUMERAL (BIT1 0%N))) (real_pow x n).
Axiom thm_REAL_POW_1_LT : forall n : N, forall x : real, ((~ (n = (NUMERAL 0%N))) /\ ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_lt x (real_of_num (NUMERAL (BIT1 0%N)))))) -> real_lt (real_pow x n) (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_REAL_POW_MONO_LT : forall m : N, forall n : N, forall x : real, ((real_lt (real_of_num (NUMERAL (BIT1 0%N))) x) /\ (N.lt m n)) -> real_lt (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_POW : forall x : real, forall m : N, forall n : N, (real_pow (real_pow x m) n) = (real_pow x (N.mul m n)).
Axiom thm_REAL_EQ_RCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (NUMERAL 0%N)))) /\ ((real_mul x z) = (real_mul y z))) -> x = y.
Axiom thm_REAL_EQ_LCANCEL_IMP : forall x : real, forall y : real, forall z : real, ((~ (z = (real_of_num (NUMERAL 0%N)))) /\ ((real_mul z x) = (real_mul z y))) -> x = y.
Axiom thm_REAL_LT_DIV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) x) /\ (real_lt (real_of_num (NUMERAL 0%N)) y)) -> real_lt (real_of_num (NUMERAL 0%N)) (real_div x y).
Axiom thm_REAL_LE_DIV : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_of_num (NUMERAL 0%N)) y)) -> real_le (real_of_num (NUMERAL 0%N)) (real_div x y).
Axiom thm_REAL_DIV_POW2 : forall x : real, forall m : N, forall n : N, (~ (x = (real_of_num (NUMERAL 0%N)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (N.le n m) (real_pow x (N.sub m n)) (real_inv (real_pow x (N.sub n m)))).
Axiom thm_REAL_DIV_POW2_ALT : forall x : real, forall m : N, forall n : N, (~ (x = (real_of_num (NUMERAL 0%N)))) -> (real_div (real_pow x m) (real_pow x n)) = (@COND real (N.lt n m) (real_pow x (N.sub m n)) (real_inv (real_pow x (N.sub n m)))).
Axiom thm_REAL_LT_POW2 : forall n : N, real_lt (real_of_num (NUMERAL 0%N)) (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) n).
Axiom thm_REAL_LE_POW2 : forall n : N, real_le (real_of_num (NUMERAL (BIT1 0%N))) (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) n).
Axiom thm_REAL_POW2_ABS : forall x : real, (real_pow (real_abs x) (NUMERAL (BIT0 (BIT1 0%N)))) = (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))).
Axiom thm_REAL_LE_SQUARE_ABS : forall x : real, forall y : real, (real_le (real_abs x) (real_abs y)) = (real_le (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))) (real_pow y (NUMERAL (BIT0 (BIT1 0%N))))).
Axiom thm_REAL_LT_SQUARE_ABS : forall x : real, forall y : real, (real_lt (real_abs x) (real_abs y)) = (real_lt (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))) (real_pow y (NUMERAL (BIT0 (BIT1 0%N))))).
Axiom thm_REAL_EQ_SQUARE_ABS : forall x : real, forall y : real, ((real_abs x) = (real_abs y)) = ((real_pow x (NUMERAL (BIT0 (BIT1 0%N)))) = (real_pow y (NUMERAL (BIT0 (BIT1 0%N))))).
Axiom thm_REAL_LE_POW_2 : forall x : real, real_le (real_of_num (NUMERAL 0%N)) (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))).
Axiom thm_REAL_LT_POW_2 : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_pow x (NUMERAL (BIT0 (BIT1 0%N))))) = (~ (x = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_SOS_EQ_0 : forall x : real, forall y : real, ((real_add (real_pow x (NUMERAL (BIT0 (BIT1 0%N)))) (real_pow y (NUMERAL (BIT0 (BIT1 0%N))))) = (real_of_num (NUMERAL 0%N))) = ((x = (real_of_num (NUMERAL 0%N))) /\ (y = (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_POW_ZERO : forall n : N, (real_pow (real_of_num (NUMERAL 0%N)) n) = (@COND real (n = (NUMERAL 0%N)) (real_of_num (NUMERAL (BIT1 0%N))) (real_of_num (NUMERAL 0%N))).
Axiom thm_REAL_POW_MONO_INV : forall m : N, forall n : N, forall x : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ ((real_le x (real_of_num (NUMERAL (BIT1 0%N)))) /\ (N.le n m))) -> real_le (real_pow x m) (real_pow x n).
Axiom thm_REAL_POW_LE2_REV : forall n : N, forall x : real, forall y : real, ((~ (n = (NUMERAL 0%N))) /\ ((real_le (real_of_num (NUMERAL 0%N)) y) /\ (real_le (real_pow x n) (real_pow y n)))) -> real_le x y.
Axiom thm_REAL_POW_LT2_REV : forall n : N, forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) y) /\ (real_lt (real_pow x n) (real_pow y n))) -> real_lt x y.
...
Axiom thm_REAL_CONVEX_BOUND2_LE : forall (b : real), forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y b) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) (real_add (real_mul u a) (real_mul v b)).
Axiom thm_REAL_CONVEX_BOUND_LT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt x a) /\ ((real_lt y a) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))) -> real_lt (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_LE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le x a) /\ ((real_le y a) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))) -> real_le (real_add (real_mul u x) (real_mul v y)) a.
Axiom thm_REAL_CONVEX_BOUND_GT : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt a y) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))) -> real_lt a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUND_GE : forall x : real, forall y : real, forall a : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le a y) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))) -> real_le a (real_add (real_mul u x) (real_mul v y)).
Axiom thm_REAL_CONVEX_BOUNDS_LE : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_le a x) /\ ((real_le x b) /\ ((real_le a y) /\ ((real_le y b) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))))) -> (real_le a (real_add (real_mul u x) (real_mul v y))) /\ (real_le (real_add (real_mul u x) (real_mul v y)) b).
Axiom thm_REAL_CONVEX_BOUNDS_LT : forall x : real, forall y : real, forall a : real, forall b : real, forall u : real, forall v : real, ((real_lt a x) /\ ((real_lt x b) /\ ((real_lt a y) /\ ((real_lt y b) /\ ((real_le (real_of_num (NUMERAL 0%N)) u) /\ ((real_le (real_of_num (NUMERAL 0%N)) v) /\ ((real_add u v) = (real_of_num (NUMERAL (BIT1 0%N)))))))))) -> (real_lt a (real_add (real_mul u x) (real_mul v y))) /\ (real_lt (real_add (real_mul u x) (real_mul v y)) b).
...
Axiom thm_REAL_ARCH : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> forall y : real, exists n : N, real_lt y (real_mul (real_of_num n) x).
Axiom thm_REAL_ARCH_INV : forall e : real, (real_lt (real_of_num (NUMERAL 0%N)) e) = (exists n : N, (~ (n = (NUMERAL 0%N))) /\ ((real_lt (real_of_num (NUMERAL 0%N)) (real_inv (real_of_num n))) /\ (real_lt (real_inv (real_of_num n)) e))).
Axiom thm_REAL_POW_LBOUND : forall x : real, forall n : N, (real_le (real_of_num (NUMERAL 0%N)) x) -> real_le (real_add (real_of_num (NUMERAL (BIT1 0%N))) (real_mul (real_of_num n) x)) (real_pow (real_add (real_of_num (NUMERAL (BIT1 0%N))) x) n).
Axiom thm_REAL_ARCH_POW : forall x : real, forall y : real, (real_lt (real_of_num (NUMERAL (BIT1 0%N))) x) -> exists n : N, real_lt y (real_pow x n).
Axiom thm_REAL_ARCH_POW2 : forall x : real, exists n : N, real_lt x (real_pow (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) n).
Axiom thm_REAL_ARCH_POW_INV : forall x : real, forall y : real, ((real_lt (real_of_num (NUMERAL 0%N)) y) /\ (real_lt x (real_of_num (NUMERAL (BIT1 0%N))))) -> exists n : N, real_lt (real_pow x n) y.
Axiom thm_real_sgn : forall x : real, (real_sgn x) = (@COND real (real_lt (real_of_num (NUMERAL 0%N)) x) (real_of_num (NUMERAL (BIT1 0%N))) (@COND real (real_lt x (real_of_num (NUMERAL 0%N))) (real_neg (real_of_num (NUMERAL (BIT1 0%N)))) (real_of_num (NUMERAL 0%N)))).
Axiom thm_REAL_SGN_0 : (real_sgn (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
...
Axiom thm_REAL_SGN_EQ : (forall x : real, ((real_sgn x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N)))) /\ ((forall x : real, ((real_sgn x) = (real_of_num (NUMERAL (BIT1 0%N)))) = (real_gt x (real_of_num (NUMERAL 0%N)))) /\ (forall x : real, ((real_sgn x) = (real_neg (real_of_num (NUMERAL (BIT1 0%N))))) = (real_lt x (real_of_num (NUMERAL 0%N))))).
Axiom thm_REAL_SGN_CASES : forall x : real, ((real_sgn x) = (real_of_num (NUMERAL 0%N))) \/ (((real_sgn x) = (real_of_num (NUMERAL (BIT1 0%N)))) \/ ((real_sgn x) = (real_neg (real_of_num (NUMERAL (BIT1 0%N)))))).
Axiom thm_REAL_SGN_INEQS : (forall x : real, (real_le (real_of_num (NUMERAL 0%N)) (real_sgn x)) = (real_le (real_of_num (NUMERAL 0%N)) x)) /\ ((forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (real_sgn x)) = (real_lt (real_of_num (NUMERAL 0%N)) x)) /\ ((forall x : real, (real_ge (real_of_num (NUMERAL 0%N)) (real_sgn x)) = (real_ge (real_of_num (NUMERAL 0%N)) x)) /\ ((forall x : real, (real_gt (real_of_num (NUMERAL 0%N)) (real_sgn x)) = (real_gt (real_of_num (NUMERAL 0%N)) x)) /\ ((forall x : real, ((real_of_num (NUMERAL 0%N)) = (real_sgn x)) = ((real_of_num (NUMERAL 0%N)) = x)) /\ ((forall x : real, (real_le (real_sgn x) (real_of_num (NUMERAL 0%N))) = (real_le x (real_of_num (NUMERAL 0%N)))) /\ ((forall x : real, (real_lt (real_sgn x) (real_of_num (NUMERAL 0%N))) = (real_lt x (real_of_num (NUMERAL 0%N)))) /\ ((forall x : real, (real_ge (real_sgn x) (real_of_num (NUMERAL 0%N))) = (real_ge x (real_of_num (NUMERAL 0%N)))) /\ ((forall x : real, (real_gt (real_sgn x) (real_of_num (NUMERAL 0%N))) = (real_gt x (real_of_num (NUMERAL 0%N)))) /\ (forall x : real, ((real_sgn x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N)))))))))))).
Axiom thm_REAL_SGN_POW : forall x : real, forall n : N, (real_sgn (real_pow x n)) = (real_pow (real_sgn x) n).
Axiom thm_REAL_SGN_POW_2 : forall x : real, (real_sgn (real_pow x (NUMERAL (BIT0 (BIT1 0%N))))) = (real_sgn (real_abs x)).
...
Axiom thm_REAL_SGNS_EQ : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (NUMERAL 0%N))) = (y = (real_of_num (NUMERAL 0%N)))) /\ (((real_gt x (real_of_num (NUMERAL 0%N))) = (real_gt y (real_of_num (NUMERAL 0%N)))) /\ ((real_lt x (real_of_num (NUMERAL 0%N))) = (real_lt y (real_of_num (NUMERAL 0%N)))))).
Axiom thm_REAL_SGNS_EQ_ALT : forall x : real, forall y : real, ((real_sgn x) = (real_sgn y)) = (((x = (real_of_num (NUMERAL 0%N))) -> y = (real_of_num (NUMERAL 0%N))) /\ (((real_gt x (real_of_num (NUMERAL 0%N))) -> real_gt y (real_of_num (NUMERAL 0%N))) /\ ((real_lt x (real_of_num (NUMERAL 0%N))) -> real_lt y (real_of_num (NUMERAL 0%N))))).
...
Axiom thm_sqrt : forall x : real, (sqrt x) = (@ε real (fun y : real => ((real_sgn y) = (real_sgn x)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 0%N)))) = (real_abs x)))).
Axiom thm_SQRT_UNIQUE : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) y) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 0%N)))) = x)) -> (sqrt x) = y.
Axiom thm_POW_2_SQRT : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> (sqrt (real_pow x (NUMERAL (BIT0 (BIT1 0%N))))) = x.
Axiom thm_SQRT_0 : (sqrt (real_of_num (NUMERAL 0%N))) = (real_of_num (NUMERAL 0%N)).
Axiom thm_SQRT_1 : (sqrt (real_of_num (NUMERAL (BIT1 0%N)))) = (real_of_num (NUMERAL (BIT1 0%N))).
Axiom thm_POW_2_SQRT_ABS : forall x : real, (sqrt (real_pow x (NUMERAL (BIT0 (BIT1 0%N))))) = (real_abs x).
Axiom thm_SQRT_WORKS_GEN : forall x : real, ((real_sgn (sqrt x)) = (real_sgn x)) /\ ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 0%N)))) = (real_abs x)).
Axiom thm_SQRT_UNIQUE_GEN : forall x : real, forall y : real, (((real_sgn y) = (real_sgn x)) /\ ((real_pow y (NUMERAL (BIT0 (BIT1 0%N)))) = (real_abs x))) -> (sqrt x) = y.
...
Axiom thm_SQRT_WORKS : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> (real_le (real_of_num (NUMERAL 0%N)) (sqrt x)) /\ ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 0%N)))) = x).
Axiom thm_REAL_POS_EQ_SQUARE : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) = (exists y : real, (real_pow y (NUMERAL (BIT0 (BIT1 0%N)))) = x).
Axiom thm_SQRT_POS_LE : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> real_le (real_of_num (NUMERAL 0%N)) (sqrt x).
Axiom thm_SQRT_POW_2 : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) x) -> (real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 0%N)))) = x.
Axiom thm_SQRT_POW2 : forall x : real, ((real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 0%N)))) = x) = (real_le (real_of_num (NUMERAL 0%N)) x).
...
Axiom thm_SQRT_LT_0 : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) (sqrt x)) = (real_lt (real_of_num (NUMERAL 0%N)) x).
Axiom thm_SQRT_EQ_0 : forall x : real, ((sqrt x) = (real_of_num (NUMERAL 0%N))) = (x = (real_of_num (NUMERAL 0%N))).
Axiom thm_SQRT_LE_0 : forall x : real, (real_le (real_of_num (NUMERAL 0%N)) (sqrt x)) = (real_le (real_of_num (NUMERAL 0%N)) x).
...
Axiom thm_SQRT_EQ_1 : forall x : real, ((sqrt x) = (real_of_num (NUMERAL (BIT1 0%N)))) = (x = (real_of_num (NUMERAL (BIT1 0%N)))).
Axiom thm_SQRT_POS_LT : forall x : real, (real_lt (real_of_num (NUMERAL 0%N)) x) -> real_lt (real_of_num (NUMERAL 0%N)) (sqrt x).
Axiom thm_REAL_LE_LSQRT : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) y) /\ (real_le x (real_pow y (NUMERAL (BIT0 (BIT1 0%N)))))) -> real_le (sqrt x) y.
...
Axiom thm_REAL_SQRT_POW_2 : forall x : real, (real_pow (sqrt x) (NUMERAL (BIT0 (BIT1 0%N)))) = (real_abs x).
Axiom thm_REAL_ABS_LE_SQRT_POS : forall x : real, forall y : real, ((real_le (real_of_num (NUMERAL 0%N)) x) /\ (real_le (real_of_num (NUMERAL 0%N)) y)) -> real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_abs (real_sub x y))).
Axiom thm_REAL_ABS_LE_SQRT : forall x : real, forall y : real, real_le (real_abs (real_sub (sqrt x) (sqrt y))) (sqrt (real_mul (real_of_num (NUMERAL (BIT0 (BIT1 0%N)))) (real_abs (real_sub x y)))).
