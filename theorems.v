...
Axiom thm_FILTER : forall {A : Type'} (h : A) (P : A -> Prop) (t : list A), ((@List.filter A P (@nil A)) = (@nil A)) /\ ((@List.filter A P (@cons A h t)) = (@COND (list A) (P h) (@cons A h (@List.filter A P t)) (@List.filter A P t))).
...
Axiom thm_FILTER_APPEND : forall {A : Type'}, forall P : A -> Prop, forall l1 : list A, forall l2 : list A, (@List.filter A P (@app A l1 l2)) = (@app A (@List.filter A P l1) (@List.filter A P l2)).
Axiom thm_FILTER_MAP : forall {A B : Type'}, forall P : B -> Prop, forall f : A -> B, forall l : list A, (@List.filter B P (@List.map A B f l)) = (@List.map A B f (@List.filter A (@o A B Prop P f) l)).
Axiom thm_MEM_FILTER : forall {A : Type'}, forall P : A -> Prop, forall l : list A, forall x : A, (@List.In A x (@List.filter A P l)) = ((P x) /\ (@List.In A x l)).
...
Axiom thm_ALL_FILTER : forall {A : Type'}, forall P : A -> Prop, forall Q : A -> Prop, forall l : list A, (@List.Forall A P (@List.filter A Q l)) = (@List.Forall A (fun x : A => (Q x) -> P x) l).
